...
import userExp from "../../styles/assets/images/user-exp.jpg"
          ...
          <Col xs={12}>
            <div className="mx-5 text-dark">
              ...
              <p>
                ...
                be a key driver of revenue. However, building and maintaining a
                website is no easy task. That's where a professional web
    ...
    <Container>
      ...
      <Row className="my-5">
        <Col md={12}>
          <Row>
            <Col md={12} lg={6}>
              <Row className="service-blog">
                <div className="d-block">
                  <h6>Expertise and experience</h6>
                  <p>
                    Web development is a complex field that requires a wide
                    range of skills, from coding to design to user experience. A
                    professional web development team will have the expertise
                    and experience necessary to build a high-quality website
            ...
            <Col md={12} lg={6}>
              <div className="service-blog-img">
                <img
                  className="d-flex m-auto d-flex justify-content-center"
                  src={expertise}
                  alt="expertise"
                />
              </div>
            ...
            <Col md={12} lg={6}>
              <Row className="service-blog">
                <div className="d-block">
                  <h6>Time-saving</h6>
                  <p>
                    Building and maintaining a website can be time-consuming,
                    especially if you don't have the technical skills or
                    knowledge. By outsourcing web development to a professional
                    team, you can save time and focus on running your business.
                  </p>
                </div>
              </Row>
            </Col>
            ...
            <Col md={12} lg={6}>
              <Row className="service-blog">
                <div className="d-block">
                  ...
                  <p>
                    A professional web development team can design and build a
                    website that is user-friendly, easy to navigate, and
                    visually appealing. This can help to improve the user
                    experience and encourage visitors to stay on your site
                    longer, increasing the chances of conversion.
                  </p>
                </div>
              </Row>
            </Col>
        ...
        <Row className="stats mt-5 p-5">
          <Col md={12} lg={12} xl={5}>
            <div className="text-dark">
              ...
              <h5 className="fs-2">Technology Stack Our Web Developers Use</h5>
              <p>
                Justtry has a team of passionate and expert developers who are
                well versed in the latest web technologies and frameworks.
                Whatever technology or framework you name it our developer will
                develop a perfect web solution using the desired framework to
        ...
        <Col xs={12}>
          <div className="service-blog d-block mt-5">
            ...
            <p>
              ...
              can be a smart decision for any business looking to improve their
              online presence. Whether you need a new website or an update to an
              existing one, a professional team can provide the expertise and
              experience necessary to create a high-quality, user-friendly site
